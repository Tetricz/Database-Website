...
WHERE employee.job = job.job 
ORDER BY first_name, last_name;
/*Selects ssn, first and last name, email, gender, street num, city, country, job, current airport code, and benefits from the employee and job tables-->*/SELECT shift_id, officeshift.office_id, airport_code, shift_start, shift_end, ground_worker_1, ground_worker_2, office_worker_1, office_worker_2 
...
FROM officeshift, office 
WHERE officeshift.office_id = office_num;
/*Selects ssns to assign that have their current_airport_code the same as the office id: 5 airport code and job: ground crew-->*/
SELECT social_security_num FROM employee 
WHERE current_airport_code = 
  (SELECT airport_code
    FROM office
    WHERE office_num = 5) 
    AND job = 'office worker';
/*Selects ssns to assign that have their current_airport_code the same as the office id: 5 airport code and job: office worker-->*/
SELECT social_security_num FROM employee 
WHERE current_airport_code = 
  (SELECT airport_code
    FROM office
...
FROM officeshift, office 
WHERE officeshift.office_id = office_num;
/*Selects ssns to assign that have their current_airport_code the same as the office id: 3 airport code and job: ground crew-->*/
SELECT social_security_num FROM employee 
WHERE current_airport_code = 
  (SELECT airport_code
    FROM office
    WHERE office_num = 3) 
    AND job = 'office worker';
/*Selects ssns to assign that have their current_airport_code the same as the office id: 3 airport code and job: office worker-->*/
SELECT social_security_num FROM employee 
WHERE current_airport_code = 
  (SELECT airport_code
    FROM office
